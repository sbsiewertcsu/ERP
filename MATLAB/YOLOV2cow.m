...
% Load the training data for cow detection into the workspace.
...
img = imread('detectcows.png');
%% 
% Run the trained YOLO v2 object detector on the test image for cow detection.
