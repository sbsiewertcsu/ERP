...
% Load the training data for car detection into the workspace.
...
if doTraining
    ...
    [anchorBoxes,meanIoU] = estimateAnchorBoxes(blds,5);
    net=resnet50();
    %analyzeNetwork(net);
...
% reduce initial learn rate from 0.001 to 1e-5
...
%% 
% Run the trained YOLO v2 object detector on the test image for car detection.
