%% Train YOLO v2 Network for Elephant Detection
...
% Load the training data for grndeleph detection into the workspace.
...
if doTraining
% check the input size and anchor box sizes!!
%    inputSize = [300 300 3]
    inputSize = [420 420 3]
...
% reduce learning rate from 0.001 to 1e-5
